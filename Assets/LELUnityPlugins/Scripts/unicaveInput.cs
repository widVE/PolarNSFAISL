...
public class unicaveInput : MonoBehaviour  {
    ...
    private void syncInputs()
    {
        ...
        {
            changeFile = true;
            if (/* file.Name != "unicaveInput.cs" */ file.Name == "testScript.cs")
            {
                ...
                for (int i = 0; i < chars.Count; i++)
                {
                    if (chars[i] == 'I' && chars[i + 1] == 'n' && chars[i + 2] == 'p' && chars[i + 3] == 'u' && chars[i + 4] == 't' && chars[i + 5] == '.')
                    {
                        ...
                        if (changeFile)
                        {
                            ...
                            //Debug.Log("Found one in: " + file);
                        }
                        i += 11;
                        //check if 'getButtonDown' is being called
                        if (chars[i + 6] == 'G' && chars[i + 9] == 'B' && chars[i + 15] == 'D')
                        {
                            ...
                            //uInput newInput2 = new uInput(inputNameString, false);
                            //newInput2.name = inputNameString;
