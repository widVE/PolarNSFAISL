...
/// Final Color:
                return fixed4(finalColor,saturate(((pow(((1.0 - node_420.r)-_CloudGrowth),0.4)*node_420.b)*2.0)));
            }
            ENDCG
        }
    }
