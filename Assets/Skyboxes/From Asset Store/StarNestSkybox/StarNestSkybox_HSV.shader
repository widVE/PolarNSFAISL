...
//Modified to include HSV conversions
//Performance is negligibly worse than the Non-HSV version
//Meaning there's barely any difference between the two except on toasters.

Shader "Skybox/StarNestHue" {
	Properties {
		...
		_PostSat ("Saturation Shift", Range(-1,1)) = 0
